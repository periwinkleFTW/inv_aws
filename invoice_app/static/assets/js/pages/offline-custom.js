...
$(document).ready(function($) {
    ...
    var a = [
        ...
        b = function() {
            var c;
            $(".browser iframe").each(function() {
                var b = $(this).contents().find(".offline-ui"),
                    d = b.find(".offline-ui-content");
